...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "SHARK")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "SHARK")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/SHARK_API_BOT")
    ...
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/SHARK_API_BOT"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "<b>- تم الاستخـراج بواسطـة ☕️  @SHARK_API_BOT</b>")
